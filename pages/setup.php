...
if ($ldapauth['enable'])
{
  ...
  $ldapConf['host'] = $ldapauth['ldapserver'];
	...
	if ($objLDAP->connect())
	{
		...
		{
			// get the groups
			echo " GOT TO THE GROUP SELECT ";
			$ldapGroupList = $objLDAP->listGroups($ldapauth['ldaptype']);
		}
...
<div class="BasicsBox"> 
  ...
  <div class="VerticalNav">
    ...
    <form id="form1" name="form1" method="post" action="">
      ...
      <p><label for="ldapserver">LDAP Server:</label><input name="ldapserver" type="text" value="<?php echo $ldapauth['ldapserver']; ?>" size="30" /><label for="ldapauth">:</label><input name="port" type="text" value="<?php echo $ldapauth['port']; ?>" size="6" /></p>

      <fieldset>
        <legend>LDAP Information</legend>
	  <table>
	  	<tr><th><label for="ldaptype">LDAP Type:</label></th><td>
	    ...
	    <tr><th><label for="rootdn">AD Admin:</label></th><td><input name="rootdn" type="text" value="<?php echo $ldapauth['rootdn']; ?>" size="30" /></td></tr>
	    <tr><th><label for="rootpass">AD Password:</label></th><td><input name="rootpass" type="password" value="<?php echo $ldapauth['rootpass']; ?>" size="30" /></td></tr>
	   <tr><th><label for="addomian">AD Domain:</label></th><td><input name="addomain" type="text" value="<?php if (isset($ldapauth['addomain'])) { echo $ldapauth['addomain']; }?>" size="30" /></td></tr>
	   
	    <tr><th><label for="basedn">Base DN:</label></th><td><input name="basedn" type="text" value="<?php echo $ldapauth['basedn']; ?>" size="30" /></td></tr>
	    <tr><th><label for="ldapusercontainer">User Container:</label></th><td><input name="ldapusercontainer" type="text" value="<?php echo $ldapauth['ldapusercontainer']; ?>" size="30" /></td></tr>
	    <tr><th><label for="loginfield">Login Field:</label></th><td><input name="loginfield" type="text" value="<?php echo $ldapauth['loginfield']; ?>" size="30" /></td></tr>
	...
	<fieldset><legend>ResourceSpace Configuration</legend>
	  <table>
            <tr><th><label for="usersuffix">User Suffix:</label></th><td><input name="usersuffix" type="text" value="<?php echo $ldapauth['usersuffix']; ?>" size="30" /></td></tr>
            <tr><th><label for="createusers">Create Users:</label></th><td><input name="createusers" type="checkbox" <?php echo $createusers; ?> /></td></tr>
